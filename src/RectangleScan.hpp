...
namespace pyscan {
    ...
    Subgrid maxSubgridKullSlow(Grid<Weight> const &grid, double rho) {
        return maxSubgridNonLinear(grid, kulldorff, rho);
    }

    template<typename Weight>
    Subgrid maxSubgridLinearSlow(Grid<Weight> const& grid, double a, double b) {
     ...
     */
    template<typename Weight>
    Subgrid maxSubgridLinearSimple(Grid<Weight> const &grid, double a, double b) {
