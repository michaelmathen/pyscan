...
def line_error_test_fast(red_points, blue_points, weights, n=None):
    """
    :param big_samp:
    :param small_samp:
    :param weights:
    ...
    if n is not None:
        net_sample = random.sample(blue_points, n)
    else:
        net_sample = blue_points[:]
