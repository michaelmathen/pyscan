...
.. toctree::
   ...
   examples/PhilyCrime.ipynb


Installation
==================

To compile this library you will need the following dependencies.
...
You should then be able to use this library as a standard python module.
